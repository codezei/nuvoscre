...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function tabs(sectionClass) {
    ...
    if (!section) return;
    var tabItems = section.querySelectorAll('.tab-content');
    var tabButtons = section.querySelectorAll('.tab-navigation__category');
    var activeButton = section.querySelector('.tab-navigation__category.active');
    var activeItem = section.querySelector('.tab-content.active');
